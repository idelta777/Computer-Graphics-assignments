...
public class Ex9ConeYoyo {
    ...
    private Appearance appearance,apariencia;
    ...
    Ex9ConeYoyo() {
        ...
        appearance.setMaterial(new Material(
                new Color3f(.3f, .3f, .3f),
                new Color3f(.4f, .4f, .5f),
                new Color3f(.5f, .5f, .5f),
                new Color3f(.6f, .6f, .6f),1f)
                );
        apariencia = new Appearance();
        apariencia.setCapability(Appearance.ALLOW_MATERIAL_WRITE);
        apariencia.setMaterial(new Material(
                new Color3f(.5f, .345f, .56f),
                new Color3f(.54f, .456f, .546f),
                new Color3f(.23f, .456f, .563f),
                new Color3f(.4f, .35f, .54f),.3f)
                );
        rotate = new Transform3D();
        translate = new Transform3D();

        translate.set(new Vector3f(0.25f, 0.0f, 0.0f));
        ...
        translate.set(new Vector3f(-0.25f, 0.f, 0.f));
        rotate.rotZ(-Math.PI / 2.0d);
        transformGroupTraslateCone2 = new TransformGroup(translate);
        transformGroupRotateCone2 = new TransformGroup(rotate);

        cone1 = new Cone(0.6f, 0.5f);
        cone2 = new Cone(0.6f, 0.5f);
        //Cone cone1 = new Cone(Primitive.GEOMETRY_NOT_SHARED);


        cone1.setAppearance(appearance) ;
        cone2.setAppearance(apariencia);
